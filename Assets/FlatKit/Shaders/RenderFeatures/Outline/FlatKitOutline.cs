...
namespace FlatKit
{
    public class FlatKitOutline : ScriptableRendererFeature
    {
        ...
        private void UpdateShader()
        {
            ...
            _material.SetFloat(DepthThresholdMin, settings.minDepthThreshold * depthThresholdScale);
            _material.SetFloat(DepthThresholdMax, settings.maxDepthThreshold * depthThresholdScale);
