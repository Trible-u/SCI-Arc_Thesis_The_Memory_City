    ...
    public class BeautifyRendererFeature : ScriptableRendererFeature {
        ...
        class BeautifyRenderPass : ScriptableRenderPass {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
                ...
                if (cameraData.camera.cameraType == CameraType.SceneView && beautify.hideInSceneView.value) return;
            ...
            void UpdateMaterialProperties() {
                ...
                bool usesSharpen = beautify.sharpenIntensity.value > 0 && (beautify.optimizeBuildBeautifyAuto.value || !beautify.stripBeautifySharpen.value);
                if (usesSharpen) {
                    ...
                    float tempSharpen = Mathf.Clamp(sharpenIntensity - currSens, 0, sharpenIntensity);
                    ...
                    if (beautify.lensDirtIntensity.value > 0 || beautify.bloomIntensity.value > 0 || beautify.anamorphicFlaresIntensity.value > 0 || sunFlareEnabled) {
                        ...
                        if (beautify.bloomIntensity.value > 0 || (beautify.lensDirtIntensity.value > 0 && beautify.anamorphicFlaresIntensity.value <= 0)) {
                            ...
                            if (beautify.bloomDepthAtten.value > 0) {
                                bMat.EnableKeyword(SKW_BLOOM_USE_DEPTH);
                ...
                bMat.shaderKeywords = keywords.ToArray();
            }
            ...
            void CheckCameraDepthTextureMode() {
